...
{
/*
	int clear = _find_last_set_bit(*mts) - 23;
	...
	do{
		...
		*/
		...
		/*
			signed bit check 
			(1)case 1(+)(+)	
			(2)case 2 alligment mantisa (+)>(-)
			(3)other (-)
		*/
		if(0 == d1.parts.sig && 0 == d2.parts.sig)
		{
			sum.parts.sig = 0;
		}	
		else if(0 == d1.parts.sig  && mts1 > mts2)
		{
			sum.parts.sig = 0;
		}
		else if(0 == d2.parts.sig && mts2 > mts1)
		{
			sum.parts.sig = 0;
		}
		else
